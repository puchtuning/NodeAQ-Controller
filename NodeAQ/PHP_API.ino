void mysql_api(String Controller_ID,String loctime,String locdate,String aq_sen1_temp,String aq_light1_status,String aq_heater1_status,String aq_co21_status){
    ...
    String mysql_api_url = "http://192.168.0.103/_api/mysql-api.php?controller_id=" + Controller_ID + "&timestamp=" + loctime + "%20" + locdate + "&aq_temp=" + aq_sen1_temp + "&aq_mainlight=" + aq_light1_status + "&aq_heater=" + aq_heater1_status + "&aq_co2_dosing=" + aq_co21_status;
